(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".customizer-color li").on("click", function () {
      ...
      $("#color").attr("href", ASSET_PATH + "css/" + color + ".css");
  ...
  $(document).ready(function () {
    ...
    switch (layout) {
      ...
      case "normal-sidebar": {
        ...
        $(".logo-wrapper").find("img").attr("src", ASSET_PATH + "images/logo/logo.png");
