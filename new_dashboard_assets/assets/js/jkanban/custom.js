        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">23/02/24</span><span class="badge badge-success f-right">Low</span>
                                  <h6>CRUD Complete</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/1.jpg">
                                  ...
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                      data-bs-title="Leia Holland"><img class="img-30 common-circle"
                                        src="${window.dashboardAssets || '../assets/'}images/user/3.png" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                      data-bs-title="Keaton Farley"><img class="img-30 common-circle"
                                        src="${window.dashboardAssets || '../assets/'}images/user/12.png" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">05/04/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/5.jpg">
                                    <div class="flex-grow-1">
                                  ...
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Kellen Munoz">
                                      <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/4.jpg" alt="user">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Baylor Hancock">
                                      <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/9.jpg"
                                        alt="user">
                                    </li>
                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Aleah Yang"><img class="img-30 common-circle"
                                          src="${window.dashboardAssets || '../assets/'}images/user/14.png" alt="user"></li>
                                    </li>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">23/07/24</span><span class="badge badge-primary f-right">Medium</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/user/3.jpg" alt="" data-original-title="" title="">
                                    <div class="flex-grow-1">
                                      <p>Thaddeus Mercer</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Marley Ford"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/3.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Sarah Wilson"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/7.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jessica Anderson"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/8.jpg" alt="user"></li>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">12/05/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/4.png" alt="">
                                    <div class="flex-grow-1">
                                      <p>Aurora Sterling</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Ford Stoll"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/9.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Davis Jone"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/1.jpg" alt="user"></li>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">28/06/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>Issues to Fix</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/12.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Juniper Ashford</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Davis Jone"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/12.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Dashiell Wolfe"><img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/5.png" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="4+ More"> 
                                        <div class="common-circle bg-lighter-dark">4+</div>
                                    </ul>
                                  </div></a>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">08/08/24</span><span class="badge badge-success f-right">Low</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/11.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Elowen Hartley</p>
                                    </div>
                                  </div>
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Elizabeth Davis"><img class="img-30 common-circle"
                                          src="${window.dashboardAssets || '../assets/'}images/avtar/3.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
                                      data-bs-title="Oceana Meridian"><img class="img-30 common-circle"
                                        src="${window.dashboardAssets || '../assets/'}images/user/2.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">14/09/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>Code Review</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/13.jpg">
                                    <div class="flex-grow-1">
                                      <p>Evander Whitman</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Levine Raven">
                                      <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/2.jpg"
                                        alt="user">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                      data-bs-title="Charles Rodriguez"><img class="img-30 common-circle"
                                        src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/5.jpg" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                      data-bs-title="Jessica Anderson"><img class="img-30 common-circle"
                                        src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/2.png" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">12/10/24</span><span class="badge badge-primary f-right">Medium</span>
                                  <h6>Bug Tracking</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/4.jpg">
                                    <div class="flex-grow-1">
                                      <p>Peregrine Huxley</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Cassian Lockwood">
                                      <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/user/12.png" alt="user">
                                    </li>
                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Marigold Winslow"><img class="img-30 common-circle"
                                          src="${window.dashboardAssets || '../assets/'}images/user/10.jpg" alt="user"></li>
                                    </li>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">02/02/24</span><span class="badge badge-info f-right">Medium</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/1.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Alia Bond</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Alexis Taylor">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/10.jpg"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Andrew Price">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/11.jpg"
                                          alt="user">
                                      </li>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">10/03/24</span><span class="badge badge-success f-right">Low</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/2.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Josie Coffey</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Caleb Rivera">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/12.jpg"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Olivia Gor"><img
                                          class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/13.jpg"
                                          alt="user"></li>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">08/04/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>Log Analysis</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/7.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Tobias Murray</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Dashiell Wolfe">
                                      <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/5.png"
                                        alt="user">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="7+ More">
                                      <div class="common-circle bg-lighter-dark">7+</div>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">15/05/24</span><span class="badge badge-success f-right">Low</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/user/14.png" alt="">
                                    <div class="flex-grow-1">
                                      <p>Zavier Walter</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Thomas Jones">
                                      <img class="img-30 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/1.png"
                                        alt="user">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Elizabeth Williams"><img class="img-30 rounded-circle"
                                    src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/3.png" alt="user"></li>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">27/10/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>User Support</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/user/6.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Morgan Mathews</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Richard Taylor">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/1.jpg"
                                          alt="user">
                                      </li>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">17/11/24</span><span class="badge badge-success f-right">Low</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/user/3.png" alt="">
                                    <div class="flex-grow-1">
                                      <p>Kehlani Soto</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Marley Ford">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/10.jpg"
                                          alt="user">
                                      </li>
                                  ...
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      ...
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Leif Hess">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/user/common-user/3.png"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="6+ More">
                                        <div class="common-circle bg-lighter-dark">6+</div>
                                  ...
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Elliott Reilly">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/1.png"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Keira Blair">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-9/user/2.png"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="5+ More">
                                        <div class="common-circle bg-lighter-dark">5+</div>
        ...
        item: [
          {
            ...
            title: `
                                 <a class="kanban-box" href="#"><span class="date">30/01/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>Configure VPN</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/2.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Eva Duke</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Andrew Price">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/user/common-user/1.png"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Kye Davidson"><img
                                          class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/user/common-user/7.png"
                                          alt="user"></li>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">18/07/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/user/12.png" alt="">
                                    <div class="flex-grow-1">
                                      <p>Jaylen Michael</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    src="${window.dashboardAssets || '../assets/'}images/user/common-user/8.png" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="4+ More">
                                      <div class="common-circle bg-lighter-dark">4+</div>
                                    </li>
                                  </ul>
        ...
        item: [
          {
            ...
            title: `
                                 <a class="kanban-box" href="#"><span class="date">01/04/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>User Support</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/8.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Leila McDowell</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jenny Wilson">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/3.jpg"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Andrew Price">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/11.jpg"
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">14/04/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/7.jpg" alt="" data-original-title="" title="">
                                    <div class="flex-grow-1">
                                      <p>Jeffery Hurley</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Jessica Anderson"><img class="img-30 common-circle"
                                    src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/8.jpg" alt="user"></li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="4+ More">
                                      <div class="common-circle bg-lighter-dark">4+</div>
                                    </li>
                                  </ul>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">19/06/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <img class="mt-2 img-fluid" src="${window.dashboardAssets || '../assets/'}images/other-images/maintenance-bg.jpg" alt="" data-original-title="" title="">
                                  <h6>Security Check</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/1.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Bobby Robertson</p>
                                    </div>
                                  </div>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">27/07/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/9.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Wren Morrison</p>
                                    </div>
                                  </div>
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Charles Rodriguez"><img class="img-30 common-circle"
                                          ...
                                          src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/6.jpg" alt="user"></li>
                                          <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="3+ More">
                                            <div class="common-circle bg-lighter-dark">3+</div>
                                          </li>
                                  </ul>
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">18/08/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  ...
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/11.jpg" alt="" data-original-title="" title="">
                                    <div class="flex-grow-1">
                                      <p>Maria Wheeler</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Joseph Garcia">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/avtar/16.jpg" alt="user">
                                      </li>
          ...
          },
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">29/09/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <img class="mt-2 img-fluid" src="${window.dashboardAssets || '../assets/'}images/other-images/sidebar-bg.jpg" alt="" data-original-title="" title="">
                                  <h6>Minify Images</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/3.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Regina Pratt</p>
                                    </div>
                                  </div>
    ...
    kanban3.addElement("_review", {
      title: `
                                 <a class="kanban-box" href="#"><span class="date">14/05/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <img class="mt-2 img-fluid" src="${window.dashboardAssets || '../assets/'}images/other-images/mountain.jpg" alt="">
                                  <h6>Minify Images</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/7.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Clayton Wilkins</p>
                                    </div>
                                  </div>
                                    ...
                                    <ul class="common-f-start">
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Jasper Nightingale"><img class="img-30 common-circle"
                                          src="${window.dashboardAssets || '../assets/'}images/dashboard/user/4.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-title="Oceana Meridian"><img class="img-30 common-circle"
                                          src="${window.dashboardAssets || '../assets/'}images/user/10.jpg" alt="user"></li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="3+ More">
        ...
        item: [
          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">12/06/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <h6>VPN Setup</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/10.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Max Melton</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      ...
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Caspian Wilde">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/5.jpg"
                                          alt="user">
                                      </li>
                                  </ul>
                                  </div></a>
...

          {
            title: `
                                 <a class="kanban-box" href="#"><span class="date">20/08/24</span><span class="badge badge-danger f-right">Urgent</span>
                                  <img class="mt-2 img-fluid" src="${window.dashboardAssets || '../assets/'}images/other-images/maintenance-bg.jpg" alt="">
                                  <h6>Audits</h6>
                                  <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard-11/user/12.jpg" alt="">
                                    <div class="flex-grow-1">
                                      <p>Elliot Gallegos</p>
                                    </div>
                                  </div>
                                  <div class="d-flex mt-3">
                                    ...
                                    <ul class="common-f-start">
                                      ...
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Caryl Kauth">
                                        <img class="img-30 common-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/1.jpg"
                                          alt="user">
                                      </li>
                                      <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="4+ More">
                                        <div class="common-circle bg-lighter-dark">4+</div>
    ...
    kanban3.addElement(
      "_review",
      {
        ...
        <a class="kanban-box" href="#"><span class="date">05/02/24</span><span class="badge badge-danger f-right">Urgent</span>
         <h6>User Support</h6>
         <div class="common-align"><img class="me-2 rounded-circle" src="${window.dashboardAssets || '../assets/'}images/dashboard/user/10.jpg" alt="">
           <div class="flex-grow-1">
             <p>Crystal Flores</p>
           </div>
         </div>
