...
(function () {
  ...
  const BOT_IMG = (window.dashboardAssets || "../assets/") + "images/dashboard/user/13.jpg";
  const PERSON_IMG = (window.dashboardAssets || "../assets/") + "images/dashboard-11/user/10.jpg";
