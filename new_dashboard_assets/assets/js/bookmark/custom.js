  ...
  if ($(".form-bookmark").valid()) {
    ...
    var bmColData =
      '<div class="col-xl-3 col-md-4 xl-50">\
	      <div class="card card-with-border bookmark-card o-hidden"><div class="details-website"><img class="img-fluid" src="' + (window.dashboardAssets || '../assets/') + 'images/lightgallry/011.jpg" alt="" data-original-title="" title="">\
