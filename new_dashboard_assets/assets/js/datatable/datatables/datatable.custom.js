(function ($) {
  $(document).ready(function () {
    ...
    $("#advance-8").DataTable({
      language: {
        url: (window.dashboardAssets || "../assets/") + "json/German.json",
      },
    });
    $("#advance-9").DataTable({
      searching: false,
    ...
    $("#ajax-data-array").DataTable({
      ajax: (window.dashboardAssets || "../assets/") + "ajax/arrays.txt",
    });
    //Ajax Data Source (Arrays) start
    //Ajax Data Source (object) start
    $("#ajax-data-object").DataTable({
      ajax: (window.dashboardAssets || "../assets/") + "ajax/object.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: (window.dashboardAssets || "../assets/") + "ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: (window.dashboardAssets || "../assets/") + "ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: (window.dashboardAssets || "../assets/") + "ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: (window.dashboardAssets || "../assets/") + "ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
    ...
    $("#datatable-post").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: (window.dashboardAssets || "../assets/") + "ajax/post.php",
        type: "post",
      },
      columns: [
        {
