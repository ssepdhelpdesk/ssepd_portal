...
return new class extends Migration
{
    ...
    {
        Schema::create('ddrc_staff_details', function (Blueprint $table) {
            $table->id();
            $table->integer('ddrc_id');
            $table->string('ddrc_name', 255);
            $table->string('ddrc_system_gen_reg_no', 255);
            $table->string('ddrc_staff_name');
            ...
            $table->string('ddrc_staff_aadhar_no', 12);
            $table->string('ddrc_file_staff_aadhar');
    ...
    {
        Schema::dropIfExists('ddrc_staff_details');
    }
};
