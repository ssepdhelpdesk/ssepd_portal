...
return new class extends Migration
{
    ...
    {
        Schema::create('disability_pensioner_consents', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('udid_no')->index();
            $table->string('disability_category')->index();
            $table->string('disability_percentage')->index();
    ...
    {
        Schema::dropIfExists('disability_pensioner_consents');
    }
};
