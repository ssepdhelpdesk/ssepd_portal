...
return new class extends Migration
{
    ...
    {
        Schema::create('pia_institute_benficiary_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('date_of_birth', 30)->index();
            $table->integer('age');
            $table->string('beneficiary_mobile', 10)->index();
            $table->integer('gender')->index();
            $table->tinyInteger('having_aadhaar')->default(1)->index();
            $table->string('aadhaar_no', 12)->nullable();
            $table->boolean('verified_aadhar')->nullable()->default(0)->index();
            ...
            $table->integer('aadhaar_not_available_reason')->nullable();
            ...
            $table->tinyInteger('having_bank_account')->default(1)->index();
            $table->string('bank_ac_no')->nullable()->index();
            $table->bigInteger('bank_ifsc')->nullable()->index();
            $table->string('beneficiary_bank_file')->nullable();
            $table->integer('bank_account_not_available_reason')->nullable();
            $table->tinyInteger('is_disabled')->default(0)->index();
            $table->integer('having_udid')->nullable();
            $table->string('udid_no')->nullable()->index();
            $table->string('beneficiary_udid_file')->nullable();
            $table->string('disability_category')->nullable();
            $table->integer('udid_not_available_reason')->nullable();
    ...
    {
        Schema::dropIfExists('pia_institute_benficiary_details');
    }
};
