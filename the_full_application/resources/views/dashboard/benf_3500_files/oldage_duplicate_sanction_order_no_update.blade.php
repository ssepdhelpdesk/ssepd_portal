@section('title') 
EP Pension || OldAge Beneficiary Data Update
@endsection 
      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="col-sm-12 col-xs-12">
               <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.oldage3500data.oldage_duplicate_sanction_order_no_update', $oldAge3500Pensioner->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                  @csrf
                  @method('post')
                  <div class="form-body">
