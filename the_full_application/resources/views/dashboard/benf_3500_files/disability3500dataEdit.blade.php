         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.disability3500data.update', $disability3500Pensioner->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="father_or_husband_name_div">
                                 ...
                                 <input type="text" id="father_or_husband_name" name="father_or_husband_name" value="{{old('father_or_husband_name', $disability3500Pensioner->father_or_husband_name)}}" class="form-control" placeholder="Name of the Staff" readonly>
