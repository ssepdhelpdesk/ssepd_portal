@section('title') 
EP Pension || Disability Data Entry
@endsection 
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.disability3500data.store')}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="scheme_name_div">
                                 ...
                                 <select class="form-control show-tick ms select2" id="scheme_name" name="scheme_name">
                                    ...
                                    <option value="IGNDP">IGNDP</option>
                                 </select>
