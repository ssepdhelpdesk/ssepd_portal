@section('title') 
EP Pensiners || New Sanctioned Abstract (Age 80+ & ≥80% Disability) || {{ \Carbon\Carbon::now('Asia/Kolkata')->format('d-m-Y h:i A') }}
@endsection 
						...
						<table id="example23" class="display nowrap table table-hover table-striped border" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th>District</th>
									<th>Total Old Age</th>
									<th>Old Age Sanctioned (Selected Date Range)</th>
									<th>Total Disability</th>
									<th>Disability Sanctioned (Selected Date Range)</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $row['OldageSanctioned'] }}</td>
									<td>{{ $row['TotalDisability'] }}</td>
									<td>{{ $row['DisabilitySanctioned'] }}</td>
									<td>{{ $row['TotalBenf'] }}</td>
