               ...
               <table id="example23" class="display nowrap table table-hover table-striped border" cellspacing="0" width="100%">
                  ...
                  <tfoot>
                     <tr>
                        ...
                        <th>District</th>
                        <th>Total Oldage</th>
                        <th>Total Oldage MBPY</th>
                        <th>Total Oldage NSAP</th>
                        <th>Oldage Death</th>
                        <th>Oldage Death MBPY</th>
                        <th>Oldage Death NSAP</th>
                        <th>Oldage Ineligible</th>
                        <th>Total Oldage Discontinued</th>
                        <th>Oldage Active</th>
                        <th>Total Disability</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $row['TotalOldageMbpy'] }}</td>
                      <td>{{ $row['TotalOldageNsap'] }}</td>
                      <td>{{ $row['OldageDeath'] }}</td>
                      <td>{{ $row['OldageDeathMbpy'] }}</td>
                      <td>{{ $row['OldageDeathNsap'] }}</td>
