@section('title') 
Disability EP Pension || Scheme Migration Using EPIC
@endsection 
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.disability3500data.disability_verify_beneficiary_using_epic_number_update', $disability3500Pensioner->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                  ...
                  <div class="col-md-3">
                     <div class="form-group" id="epic_no_div">
                        ...
                        <div class="input-group">
                           <input type="text" id="epic_no" name="epic_no" value="{{old('epic_no', $disability3500Pensioner->epic_no)}}" class="form-control" placeholder="EPIC Number">
                        </div>
...
<script>
   ...
   if (age < 0) {
      ...
      Swal.fire({
        icon: 'warning',
        title: 'Invalid Age',
        text: 'Age should not be less than 0 years.',
        timer: 2000,
...
<script type="text/javascript">
   $(document).ready(function () {
      $("#epic_no").blur(function () {
         ...
         $.get("{{ route('admin.disability3500data.disability_check_verify_beneficiary_using_epic_number') }}", 
            { epic_no: epicNo }, 
            function (data) {
               if (data == 0) {
