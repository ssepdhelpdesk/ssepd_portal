@section('title') 
EP Pension || OAP to DP Migration
@endsection 
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group" id="scheme_name_div">
											...
											<select class="form-control show-tick ms select2" id="scheme_name" name="scheme_name">
												...
												<option value="MBPDP" {{ old('scheme_name', $oldAge3500Pensioner->scheme_name ?? '') == 'MBPDP' ? 'selected' : '' }}>MBPDP</option>
												<option value="IGNDP" {{ old('scheme_name', $oldAge3500Pensioner->scheme_name ?? '') == 'IGNDP' ? 'selected' : '' }}>IGNDP</option>
											</select>
									...
									<div class="col-md-3">
										<div class="form-group" id="udid_no_div">
											...
											<input type="text" id="udid_no" name="udid_no" value="{{old('udid_no', $oldAge3500Pensioner->udid_no)}}" class="form-control" placeholder="UDID no of Beneficiary" >
									...
									<div class="col-md-3">
										<div class="form-group" id="disability_category_div">
											...
											<input type="text" id="disability_category" name="disability_category" value="{{old('disability_category', $oldAge3500Pensioner->disability_category)}}" class="form-control" placeholder="Disability category of Beneficiary" >
									...
									<div class="col-md-3">
										<div class="form-group" id="disability_percentage_div">
											...
											<select class="form-control show-tick ms select2" id="disability_percentage" name="disability_percentage">
												<option >Please Select</option>
												@for($i = 80; $i <= 100; $i++)
												<option value="{{ $i }}" {{ old('disability_percentage', $oldAge3500Pensioner->disability_percentage ?? '') == $i ? 'selected' : '' }}>
													{{ $i }}
												</option>
												@endfor
											</select>
									...
									<div class="col-md-6">
										<div class="form-group" id="current_address_div">
											...
											if ($oldAge3500Pensioner->address_type == 1) {
												$correntAddress = 'Village: ' . $oldAge3500Pensioner->village
												. ', GP: ' . $oldAge3500Pensioner->gp_or_ward
												. ', Block: ' . $oldAge3500Pensioner->block_or_ulb
												. ', District: ' . $oldAge3500Pensioner->district;
											} elseif ($oldAge3500Pensioner->address_type == 2) {
												$correntAddress = 'Ward: ' . $oldAge3500Pensioner->gp_or_ward
												. ', ULB: ' . $oldAge3500Pensioner->block_or_ulb
												. ', District: ' . $oldAge3500Pensioner->district;
											}
											@endphp
