@section('title') 
EP Pension || DP to OAP Migration
@endsection 
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  ...
                  @endif
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.schememigrationep.dp_to_oap_migration_update', $disability3500Pensioner->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                        <h5 class="card-title">OAP to DP Migration</h5>
                        <hr>
                        <div class="row">
                           <div class="col-md-3">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="father_or_husband_name_div">
                                 ...
                                 <input type="text" id="father_or_husband_name" name="father_or_husband_name" value="{{old('father_or_husband_name', $disability3500Pensioner->father_or_husband_name)}}" class="form-control" placeholder="Name of the Staff">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="date_of_birth_div">
                                 ...
                                 @php
                                 $dob = $disability3500Pensioner->date_of_birth;
                                 $age = $disability3500Pensioner->age;
                                 $isReadonly = false;
                                 $parsedDate = null;
                                 ...
                                 try {
                                    if ($dob && strtolower($dob) !== 'not provided by district') {
                                       ...
                                       if ($year >= 1700 && $year <= now()->year && !empty($age) && $age > 0 && $age <= 140) {
                                          $isReadonly = true;
                                       }
                                    }
                                 } catch (\Exception $e) {
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="age_div">
                                 ...
                                 <input type="text" id="age" name="age" value="{{old('age', $disability3500Pensioner->age)}}" class="form-control" placeholder="Age" readonly>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="gender_div">
                                 ...
                                 <select class="form-control show-tick ms select2" id="gender" name="gender">
                                    <option >Please Select</option>
                                    <option value="Male" {{ $disability3500Pensioner->gender == 'Male' ? 'selected' : '' }}>Male</option>
                                    <option value="Female" {{ $disability3500Pensioner->gender == 'Female' ? 'selected' : '' }}>Female</option>
                                 </select>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="udid_no_div">
                                 ...
                                 <input type="text" id="udid_no" name="udid_no" value="{{old('udid_no', $disability3500Pensioner->udid_no)}}" class="form-control" placeholder="UDID no of Beneficiary" readonly>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="disability_category_div">
                                 ...
                                 <input type="text" id="disability_category" name="disability_category" value="{{old('disability_category', $disability3500Pensioner->disability_category)}}" class="form-control" placeholder="Disability category of Beneficiary" readonly>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="disability_percentage_div">
                                 ...
                                 <select class="form-control show-tick ms select2" id="disability_percentage" name="disability_percentage">
                                    <option >Please Select</option>
                                    @for($i = 80; $i <= 100; $i++)
                                    <option value="{{ $i }}" {{ old('disability_percentage', $disability3500Pensioner->disability_percentage ?? '') == $i ? 'selected' : '' }}>
                                       {{ $i }}
                                    </option>
                                    @endfor
                                 </select>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="nsap_sanction_order_no_div">
                                 ...
                                 @php
                                 $nsap = trim(old('nsap_sanction_order_no', $disability3500Pensioner->nsap_sanction_order_no ?? ''));
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="sub_collector_sanction_order_no_div">
                                 ...
                                 <input type="text" id="sub_collector_sanction_order_no" name="sub_collector_sanction_order_no" value="{{old('sub_collector_sanction_order_no', $disability3500Pensioner->sub_collector_sanction_order_no)}}" class="form-control" placeholder="Sub-Collector Sanction Order No" readonly>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="pension_month_div">
                                 ...
                                 <input type="month" id="pension_month" name="pension_month" value="{{old('pension_month', $disability3500Pensioner->pension_month)}}" class="form-control" placeholder="Pension Month(Effective From)" onkeydown="return false" onpaste="return false" required="" readonly>
                           ...
                           <div class="col-md-6">
                              <div class="form-group" id="current_address_div">
                                 <label class="form-label">
                                    Current Address<span class="itsrequired"> *</span>
                                 </label>
                                 ...
                                 if ($disability3500Pensioner->address_type == 1) {
                                    $correntAddress = 'Village: ' . $disability3500Pensioner->village
                                    . ', GP: ' . $disability3500Pensioner->gp_or_ward
                                    . ', Block: ' . $disability3500Pensioner->block_or_ulb
                                    . ', District: ' . $disability3500Pensioner->district;
                                 } elseif ($disability3500Pensioner->address_type == 2) {
                                    $correntAddress = 'Ward: ' . $disability3500Pensioner->gp_or_ward
                                    . ', ULB: ' . $disability3500Pensioner->block_or_ulb
                                    . ', District: ' . $disability3500Pensioner->district;
                                 }
                                 @endphp
                                 <input type="text" class="form-control" name="current_address" id="current_address" value="{{ $correntAddress }}" readonly>
...
<script type="text/javascript">
   $(document).ready(function () {
      $("#nsap_sanction_order_no").blur(function () {
         ...
         $.get("{{ route('admin.disability3500data.check_benf_nsap_sanction_or_no') }}", 
...
<script>
   function Validate() {
      ...
      const selectFields = [
         ...
         { name: 'disability_percentage', message: 'Please select Disability Percentage.' }
      ];
