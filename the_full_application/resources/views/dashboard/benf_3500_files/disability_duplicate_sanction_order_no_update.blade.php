@section('title') 
EP Pension || Disability Beneficiary Data Update
@endsection 
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="col-sm-12 col-xs-12">
						<form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.disability3500data.disability_duplicate_sanction_order_no_update', $disability3500Pensioner->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
							@csrf
							@method('post')
							<div class="form-body">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group" id="udid_no_div">
											...
											<input type="text" id="udid_no" name="udid_no" value="{{old('udid_no', $disability3500Pensioner->udid_no)}}" class="form-control" placeholder="UDID no of Beneficiary" >
									...
									<div class="col-md-3">
										<div class="form-group" id="disability_category_div">
											...
											<input type="text" id="disability_category" name="disability_category" value="{{old('disability_category', $disability3500Pensioner->disability_category)}}" class="form-control" placeholder="Disability category of Beneficiary" >
									...
									<div class="col-md-3">
										<div class="form-group" id="sub_collector_sanction_order_no_div">
											...
											<input type="text" id="sub_collector_sanction_order_no" name="sub_collector_sanction_order_no" value="{{old('sub_collector_sanction_order_no', $disability3500Pensioner->sub_collector_sanction_order_no)}}" class="form-control" placeholder="Sub-Collector Sanction Order No" >
									...
									<div class="col-md-3">
										<div class="form-group" id="db_status_div">
											<label class="form-label">Is it a Duplicate Record<span class="itsrequired"> *</span></label>
											<div class="d-flex align-items-center">
												<div class="custom-control custom-radio me-3">
													<input type="radio" id="db_status_yes" name="db_status" value="0" class="form-check-input">
													<label class="form-check-label" for="db_status_yes">Yes</label>
												</div>
												<div class="custom-control custom-radio">
													<input type="radio" id="db_status_no" name="db_status" value="1" class="form-check-input">
													<label class="form-check-label" for="db_status_no">No</label>
												</div>
											</div>
											<div id="db_status_error"></div>
											@error('db_status')
											<label class="error">{{ $message }}</label>
											@enderror
										</div>
									...
									<div class="col-md-3">
										<div class="form-group" id="ngo_address_type_div">
											...
											<div class="d-flex align-items-center">
												...
												$showBlock = in_array($userRole, [1,2,12,13,14,15,4,6,8,10,9,11]);
												$showULB   = in_array($userRole, [1,2,12,13,14,15,5,8,10,9,11]);
												@endphp
												@if($showBlock)
												<div class="custom-control custom-radio me-3">
...
<script>
	function Validate() {
		...
		let dbRadios = document.querySelectorAll('input[name="db_status"]');
		let dbSelected = false;
		dbRadios.forEach(radio => {
			if (radio.checked) dbSelected = true;
		});

		if (!dbSelected) {
			showError('db_status', 'Please select Whether it is a Duplicate Record?');
		} else {
			clearError('db_status');
		}
