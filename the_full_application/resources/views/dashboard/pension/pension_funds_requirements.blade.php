            ...
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.pension.store')}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     ...
                     @method('post')
                     <div class="form-body">
                        <h5 class="card-title">Block/ULB wise fund requirement under MBPY for the pension month August 2025 <small>Provide the beneficiary count, not the amount.</small></h5>
                        <hr>
                        <div class="row">
                           <div class="col-md-3">
