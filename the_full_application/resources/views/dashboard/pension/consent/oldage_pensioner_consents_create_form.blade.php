@section('title') 
Pension || OldAge Pensioners Consent Data Entry
@endsection 
         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.pensionforbeneficiaries.oldage_pensioner_consents_store')}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="scheme_name_div">
                                 ...
                                 <select class="form-control show-tick ms select2" id="scheme_name" name="scheme_name">
                                    ...
                                    <option value="CaseOfLeprosyPatient">Case Of Leprosy Patient</option>
                                    <option value="WidowPensionAidsHiv">Widow Pension AIDS/HIV</option>
                                    <option value="UnmarriedWoman">Unmarried Woman</option>
                                    <option value="DivorceeWomen">Divorcee Women</option>
                                    <option value="Transgender">Transgender</option>
                                    <option value="WidowDueToCovid">Widow Due To Covid</option>
                                    <option value="OrphanDueToCovid">Orphan Due To Covid</option>
                                 </select>
