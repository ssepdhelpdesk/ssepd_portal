		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.dailypensiondisbursement.update', $dailypensiondisbursementdata->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
						@csrf
						@method('post')                     
								...
								<table id="example23" class="display nowrap table table-hover table-striped border" cellspacing="0" width="100%">
									...
									<tbody>
										<tr>
											{{-- GP/Ward Name --}}
											<td>
												<input type="hidden" name="gp_ward_id" value="{{ $user->role_name == 'BSSO' ? $dailypensiondisbursementdata->gp_id : $dailypensiondisbursementdata->ward_id }}">
												<input 
												type="text" 
												name="gp_ward_name" 
												value="{{ $user->role_name == 'BSSO' ? $dailypensiondisbursementdata->grampanchayat->gp_name : $dailypensiondisbursementdata->ward->ward_name }}" 
