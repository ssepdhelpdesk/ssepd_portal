@section('title') 
Pension || GP/Ward-wise Daily Pension Disbursement for the month - {{$forTheMonth}} || {{ \Carbon\Carbon::now('Asia/Kolkata')->format('d-m-Y h:i A') }}
@endsection 
...
<div class="row">
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title">GP/Ward-wise Daily Pension Disbursement for the month - {{$forTheMonth}}</h4>
