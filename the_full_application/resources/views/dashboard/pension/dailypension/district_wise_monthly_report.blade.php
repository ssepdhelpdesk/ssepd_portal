@section('title') 
Pension || District Wise Daily Pension Disbursement - {{$forTheMonth}} || {{ \Carbon\Carbon::now('Asia/Kolkata')->format('d-m-Y h:i A') }}
@endsection 
...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               <h4 class="card-title">District Wise Daily Pension Disbursement Report - {{$forTheMonth}}</h4>
