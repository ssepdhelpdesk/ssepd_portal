@section('title') 
Pension || MBPY Fund Requirements for the month - {{$forTheMonth1}} || {{ \Carbon\Carbon::now('Asia/Kolkata')->format('d-m-Y h:i A') }}
@endsection 
...
<div class="row">
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title">Block/ULB wise fund requirement under MBPY for the month - {{$forTheMonth1}}</h4>
                     ...
                     <td>
                        <div class="btn-group">
                           ...
                           <div class="dropdown-menu">
                             ...
                             isset($fundsRequirements->created_date) && 
                             $fundsRequirements->created_date >= $startDate && 
                             $fundsRequirements->created_date <= $endDate)
