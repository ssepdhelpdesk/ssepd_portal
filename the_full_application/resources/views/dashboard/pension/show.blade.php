         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.pension.fund_requirement_approval_process', $pensionFundsRequirement->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                        <h5 class="card-title">Update Block/ULB wise fund requirement under MBPY for the pension month August 2025</h5>
                        <hr>
                        <div class="row">
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_oap_below_80_years_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_oap_below_80_years" name="mbpy_oap_below_80_years" value="{{ old('mbpy_oap_below_80_years', $pensionFundsRequirement->mbpy_oap_below_80_years) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_oap_above_80_years_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_oap_above_80_years" name="mbpy_oap_above_80_years" value="{{ old('mbpy_oap_above_80_years', $pensionFundsRequirement->mbpy_oap_above_80_years) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_wp_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_wp" name="mbpy_wp" value="{{ old('mbpy_wp', $pensionFundsRequirement->mbpy_wp) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_dp_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_dp" name="mbpy_dp" value="{{ old('mbpy_dp', $pensionFundsRequirement->mbpy_dp) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_sdp_below_80_percent_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_sdp_below_80_percent" name="mbpy_sdp_below_80_percent" value="{{ old('mbpy_sdp_below_80_percent', $pensionFundsRequirement->mbpy_sdp_below_80_percent) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_sdp_above_80_percent_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_sdp_above_80_percent" name="mbpy_sdp_above_80_percent" value="{{ old('mbpy_sdp_above_80_percent', $pensionFundsRequirement->mbpy_sdp_above_80_percent) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_sdoap_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_sdoap" name="mbpy_sdoap" value="{{ old('mbpy_sdoap', $pensionFundsRequirement->mbpy_sdoap) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_clp_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_clp" name="mbpy_clp" value="{{ old('mbpy_clp', $pensionFundsRequirement->mbpy_clp) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_wp_aids_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_wp_aids" name="mbpy_wp_aids" value="{{ old('mbpy_wp_aids', $pensionFundsRequirement->mbpy_wp_aids) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_dp_aids_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_dp_aids" name="mbpy_dp_aids" value="{{ old('mbpy_dp_aids', $pensionFundsRequirement->mbpy_dp_aids) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_unmarried_women_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_unmarried_women" name="mbpy_unmarried_women" value="{{ old('mbpy_unmarried_women', $pensionFundsRequirement->mbpy_unmarried_women) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_orphan_due_to_covide_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_orphan_due_to_covide" name="mbpy_orphan_due_to_covide" value="{{ old('mbpy_orphan_due_to_covide', $pensionFundsRequirement->mbpy_orphan_due_to_covide) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_widow_due_to_covid_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_widow_due_to_covid" name="mbpy_widow_due_to_covid" value="{{ old('mbpy_widow_due_to_covid', $pensionFundsRequirement->mbpy_widow_due_to_covid) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_divorce_or_destitute_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_divorce_or_destitute" name="mbpy_divorce_or_destitute" value="{{ old('mbpy_divorce_or_destitute', $pensionFundsRequirement->mbpy_divorce_or_destitute) }}" class="form-control" placeholder="Enter count" min="0" step="1">
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="mbpy_transgender_div">
                                 ...
                                 <input 
                                 type="number" id="mbpy_transgender" name="mbpy_transgender" value="{{ old('mbpy_transgender', $pensionFundsRequirement->mbpy_transgender) }}" class="form-control" placeholder="Enter count" min="0" step="1">
