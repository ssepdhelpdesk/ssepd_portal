                              ...
                              <div class="card-body">
                                 <div class="profiletimeline">
                                    ...
                                    <div class="sl-item">
                                       ...
                                       <div class="sl-right">
                                          <div>
                                             <a href="javascript:void(0)" class="link">Upload the identified location for toilet construction.</a><small style="color: red;"> Please use Google Chrome to fill out this form. Other browsers may not be supported.</small> <span class="sl-date"> <a href="https://play.google.com/store/apps/details?id=com.gpsmapcamera.geotagginglocationonphoto" target="_blank"> <button class="btn btn-primary text-white from-prevent-multiple-submits">Download Geo Tag Camera App</button> </a></span> <span class="sl-date"> <a href="{{url('storage/special_school_files/toilet_construction_plan_chart.pdf')}}" target="_blank"> <button class="btn btn-info text-white from-prevent-multiple-submits">Download Plan Chart</button> </a></span>
