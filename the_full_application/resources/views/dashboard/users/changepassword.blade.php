                     ...
                     <div class="row">
                        <div class="col-lg-3" id="oldemail_div">
                           <div class="form-group">
                              ...
                              <input type="email" name="oldemail" value="{{ old('oldemail', $user->email) }}" class="form-control textInput" id="oldemail" placeholder="Enter Email ID">
...
<script type="text/javascript">
   ...
   var oldemail_error = document.getElementById('oldemail_error');
   ...
   oldemail.addEventListener('blur', emailVerify, true);
   ...
   function Validate() {
      if (oldemail.value == "") {
        ...
        document.getElementById('oldemail_div').style.color = "red";
        oldemail_error.textContent = "Please enter Email ID";
        oldemail.focus();
        return false;
     }
     ...
     if (!emailPattern.test(oldemail.value.trim())) {
        oldemail.style.border = "1px solid red";
        document.getElementById('oldemail_div').style.color = "red";
        oldemail_error.textContent = "Please enter a valid Email ID";
        oldemail.focus();
        return false;
     }
 ...
 function emailVerify() {
  ...
  if (emailPattern.test(oldemail.value.trim())) {
    oldemail.style.border = "1px solid #5e6e66";
    document.getElementById('oldemail_div').style.color = "#5e6e66";
    oldemail_error.innerHTML = "";
    return true;
 }
}
function nameVerify() {
