         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.ddrc.staff_store')}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                        ...
                        <div class="row">
                           <div class="col-md-3">
                              <div class="form-group" id="ddrc_staff_name_div">
                                 <label class="form-label">Staff Name<span class="itsrequired"> *</span></label>
                                 <input type="text" id="ddrc_staff_name" name="ddrc_staff_name" value="{{old('ddrc_staff_name')}}" class="form-control" placeholder="Name of the Staff">
                                 <div id="ddrc_staff_name_error"></div>
                                 @error('ddrc_staff_name')
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="staff_designation_div">
                                 ...
                                 <select class="select2 form-control form-select" data-placeholder="Choose a Category" tabindex="1" name="staff_designation">
                                    ...
                                    <option value="1">Clinical Psychologist/ Psychologist</option>
                                    <option value="2">Sr.Physiotherapist/ Occupational Therapist</option>
                                    <option value="3">Sr.Prosthetist/ Orthotist</option>
                                    <option value="4">Prosthetist/ Orthotist (Technician)</option>
                                    <option value="5">Sr.Speech therapist/ Audiologist</option>
                                    <option value="6">Hearing Assistant/ Junior Speech Therapist</option>
                                    <option value="7">Mobility Instructor</option>
                                    ...
                                    <option value="13">Care Giver</option>
                           ...
                           <div class="col-md-3">
                              <div class="form-group" id="ddrc_staff_aadhar_no_div">
                                 <label class="form-label">Aadhar No<span class="itsrequired"> *</span></label>
                                 <input type="text" id="ddrc_staff_aadhar_no" name="ddrc_staff_aadhar_no" value="{{old('ddrc_staff_aadhar_no')}}" class="form-control" minlength="12" maxlength="12" placeholder="Aadhar No">
                                 <div id="ddrc_staff_aadhar_no_error"></div>
                                 <div id="ddrc_staff_aadhar_no"></div>
                                 @error('ddrc_staff_aadhar_no')
                                 <label class="error">{{ $message }}</label>
                                 @enderror
                              </div>
                           </div>
                           <div class="col-md-3">
                              <div class="form-group" id="ddrc_file_staff_aadhar_div">
                                 <label class="form-label">Upload Aadhar<span class="itsrequired"> *</span></label>
                                 <input type="file" class="form-control" id="ddrc_file_staff_aadhar" name="ddrc_file_staff_aadhar" value="{{old('ddrc_file_staff_aadhar')}}" accept=".pdf" aria-describedby="inputGroupFileAddon01">
                                 <div id="ddrc_file_staff_aadhar_error"></div>
                                 @error('ddrc_file_staff_aadhar')
                                 <label class="error">{{ $message }}</label>
                                 @enderror
                              </div>
                           </div>
...
<script type="text/javascript">
   $(document).ready(function () {
      $("#ddrc_staff_aadhar_no").blur(function () {
         const staffAadhar = $(this).val().trim();
         const is12DigitNumber = /^\d{12}$/.test(staffAadhar);
   
         $('#ddrc_staff_aadhar_no').html('');
   
         if (!staffAadhar) {
            $('#ddrc_staff_aadhar_no').html('<span style="color:#FF0000">Please provide an Aadhar number.</span>');
            return;
         }
   
         if (!is12DigitNumber) {
            $('#ddrc_staff_aadhar_no').html('<span style="color:#FF0000">Aadhar must be exactly 12 digits.</span>');
            return;
         }
   
         $.get("{{ route('admin.ddrc.ddrc_check_staff_aadhar') }}", 
            { ddrc_staff_aadhar_no: staffAadhar }, 
            function (data) {
               if (data == 0) {
                  $('#ddrc_staff_aadhar_no').html('<span style="color:#03713E">This Aadhar is available.</span>');
               } else if (data == 1) {
                  $('#ddrc_staff_aadhar_no').html('<span style="color:#FF0000">This Aadhar is already registered.</span>');
                  $("#ddrc_staff_aadhar_no").val('');
               } else if (data == 2) {
                  $('#ddrc_staff_aadhar_no').html('<span style="color:#FF0000">Please provide a valid Aadhar.</span>');
               }
            }
         ).fail(function () {
            $('#ddrc_staff_aadhar_no').html('<span style="color:#FF0000">An error occurred. Please try again.</span>');
         });
      });
   });
</script>
<script>
   const aadhaarInputs = document.querySelectorAll('[name="ddrc_staff_aadhar_no"]');
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   udidInput.addEventListener('blur', function () {
      ...
      fetch(`{{ route('admin.ddrc.ddrc_check_staff_udidno') }}?udid_no=${encodeURIComponent(udid)}`)
...
<script>
   function Validate() {
      ...
      const textFields = [
         { id: 'ddrc_staff_name', message: 'Please enter Staff Name.' },
         ...
         { id: 'ddrc_staff_aadhar_no', message: 'Please enter Aadhar No.' },
      ...
      const aadharFile = document.getElementById('ddrc_file_staff_aadhar').files[0];
      if (!aadharFile) {
         showError('ddrc_file_staff_aadhar', 'Please upload the Aadhar file.');
      } else {
         clearError('ddrc_file_staff_aadhar');
   
         const allowedType = 'application/pdf';
         const maxSize = 3 * 1024 * 1024;
   
         if (aadharFile.type !== allowedType) {
            showError('ddrc_file_staff_aadhar', 'Only PDF files are allowed.');
            isValid = false;
         } else if (aadharFile.size > maxSize) {
            showError('ddrc_file_staff_aadhar', 'File size must be less than 3MB.');
            isValid = false;
         }
      }
