         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="col-sm-12 col-xs-12">
                  <form class="from-prevent-multiple-submits" method="POST" action="{{ route('admin.piainstitutes.hwh_oah_input_form_benf_details_store', $piainstitute->id)}}" onsubmit="return Validate()" name="vform" enctype="multipart/form-data">
                     @csrf
                     @method('post')
                     <div class="form-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3 aadhaar_reason_section">
                              <div class="form-group" id="aadhaar_not_available_reason_div">
                                 ...
                                 <select class="form-control show-tick ms select2" id="aadhaar_not_available_reason" name="aadhaar_not_available_reason">
                                    <option value="">Please Select</option>
                                    <option value="1" {{ old('aadhaar_not_available_reason') == '1' ? 'selected' : '' }}>Rescue from Field</option>
                                    <option value="2" {{ old('aadhaar_not_available_reason') == '2' ? 'selected' : '' }}>Finger Print Issue</option>
                                    <option value="3" {{ old('aadhaar_not_available_reason') == '3' ? 'selected' : '' }}>Iris Issue</option>
                                 </select>
                           ...
                           <div class="col-md-3">
                             <div class="form-group" id="having_bank_account_div">
                                <label class="form-label">Having Bank Account?<span class="itsrequired"> *</span></label>
                                <div class="d-flex align-items-center">
                                   <div class="custom-control custom-radio me-3">
                                      <input type="radio" id="having_bank_account_yes" name="having_bank_account" value="1"
                                      class="form-check-input" {{ old('having_bank_account', '1') == '1' ? 'checked' : '' }}>
                                      <label class="form-check-label" for="having_bank_account_yes">Yes</label>
                                   </div>
                                   <div class="custom-control custom-radio">
                                      <input type="radio" id="having_bank_account_no" name="having_bank_account" value="2"
                                      class="form-check-input" {{ old('having_bank_account') == '2' ? 'checked' : '' }}>
                                      <label class="form-check-label" for="having_bank_account_no">No</label>
                                   </div>
                                </div>
                                <div id="having_bank_account_error"></div>
                                @error('having_bank_account')
                                <label class="error">{{ $message }}</label>
                                @enderror
                             </div>
                          </div>
                          <div class="col-md-3 bank_section">
                          ...
                          <div class="col-md-3 bank_reason_section">
                             <div class="form-group" id="bank_account_not_available_reason_div">
                                <label class="form-label">Reason for Non-Availability of Bank Account<span class="itsrequired"> *</span></label>
                                <select class="form-control show-tick ms select2" id="bank_account_not_available_reason" name="bank_account_not_available_reason">
                                   <option value="">Please Select</option>
                                   <option value="1" {{ old('bank_account_not_available_reason') == '1' ? 'selected' : '' }}>No Bank Account</option>
                                   <option value="2" {{ old('bank_account_not_available_reason') == '2' ? 'selected' : '' }}>Bank Account Under Process</option>
                                   <option value="3" {{ old('bank_account_not_available_reason') == '3' ? 'selected' : '' }}>Physically Unable to Open Bank Account</option>
                                   <option value="4" {{ old('bank_account_not_available_reason') == '4' ? 'selected' : '' }}>Other</option>
                                </select>
                                <div id="bank_account_not_available_reason_error"></div>
                                @error('bank_account_not_available_reason')
                                <label class="error">{{ $message }}</label>
                                @enderror
                             </div>
                          </div>
                         ...
                         <div class="col-md-3 disability_section">
                            <div class="form-group" id="having_udid_div">
                               <label class="form-label">Having UDID Certificate?<span class="itsrequired"> *</span></label>
                               <div class="d-flex align-items-center">
                                  <div class="custom-control custom-radio me-3">
                                     <input type="radio" id="having_udid_yes" name="having_udid" value="1"
                                        class="form-check-input" {{ old('having_udid', '1') == '1' ? 'checked' : '' }}>
                                     <label class="form-check-label" for="having_udid_yes">Yes</label>
                                  </div>
                                  <div class="custom-control custom-radio">
                                     <input type="radio" id="having_udid_no" name="having_udid" value="2"
                                        class="form-check-input" {{ old('having_udid') == '2' ? 'checked' : '' }}>
                                     <label class="form-check-label" for="having_udid_no">No</label>
                                  </div>
                               </div>
                               <div id="having_udid_error"></div>
                               @error('having_udid')
                               <label class="error">{{ $message }}</label>
                               @enderror
                            </div>
                         </div>
                         <div class="col-md-3 disability_section udid_certificate_section">
                         ...
                         <div class="col-md-3 disability_section udid_reason_section">
                            <div class="form-group" id="udid_not_available_reason_div">
                               <label class="form-label">Reason for Non-Availability of UDID Certificate<span class="itsrequired"> *</span></label>
                               <select class="form-control show-tick ms select2" id="udid_not_available_reason" name="udid_not_available_reason">
                                  <option value="">Please Select</option>
                                  <option value="1" {{ old('udid_not_available_reason') == '1' ? 'selected' : '' }}>UDID Application Under Process</option>
                                  <option value="2" {{ old('udid_not_available_reason') == '2' ? 'selected' : '' }}>Recently Identified Disability</option>
                                  <option value="3" {{ old('udid_not_available_reason') == '3' ? 'selected' : '' }}>Medical Assessment Pending</option>
                                  <option value="4" {{ old('udid_not_available_reason') == '4' ? 'selected' : '' }}>Certificate Yet to be Issued by Competent Authority</option>
                                  <option value="5" {{ old('udid_not_available_reason') == '5' ? 'selected' : '' }}>Other</option>
                               </select>
                               <div id="udid_not_available_reason_error"></div>
                               @error('udid_not_available_reason')
                               <label class="error">{{ $message }}</label>
                               @enderror
                            </div>
                         </div>
...
const havingBankRadios = document.querySelectorAll('input[name="having_bank_account"]');
let havingBankSelected = false;
havingBankRadios.forEach(radio => {
  if (radio.checked) havingBankSelected = true;
});

if (!havingBankSelected) {
  showError('having_bank_account', 'Please select whether having Bank Account.');
} else {
  clearError('having_bank_account');
}
...
fileFields.forEach(field => {
  ...
  if (!el || el.files.length === 0) {
    ...
    if (isDisabled == '1') {
        const havingUdidRadios = document.querySelectorAll('input[name="having_udid"]');
        let havingUdidSelected = false;
        havingUdidRadios.forEach(radio => {
            if (radio.checked) havingUdidSelected = true;
        });
        if (!havingUdidSelected) {
            showError('having_udid', 'Please select whether having UDID Certificate.');
        } else {
            clearError('having_udid');
        }

        if (!getValue('disability_category')) {
            showError('disability_category', 'Please enter Disability Category.');
        } else {
            clearError('disability_category');
        }

        const havingUdid = document.querySelector('input[name="having_udid"]:checked')?.value;
        if (havingUdid == '1') {
            if (!getValue('udid_no')) {
                showError('udid_no', 'Please enter UDID No.');
            } else {
                clearError('udid_no');
            }

            const udidFile = document.getElementById('beneficiary_udid_file');
            if (!udidFile || udidFile.files.length === 0) {
                showError('beneficiary_udid_file', 'Please upload UDID Certificate.');
            } else {
                clearError('beneficiary_udid_file');
            }

            clearError('udid_not_available_reason');
        } else {
            const reasonVal = document.getElementById('udid_not_available_reason').value;
            if (!reasonVal) {
                showError('udid_not_available_reason', 'Please select Reason for Non-Availability of UDID Certificate.');
            } else {
                clearError('udid_not_available_reason');
            }
        ...
        ['having_udid', 'udid_no', 'beneficiary_udid_file', 'disability_category', 'udid_not_available_reason'].forEach(id => clearError(id));
    }
...
clearError('aadhaar_file');
     ...
     // ========================
     // BANK CONDITIONAL VALIDATION
     // ========================
const havingBankAccount = document.querySelector('input[name="having_bank_account"]:checked')?.value;

if (havingBankAccount == '1') {
 const bank = getValue('bank_ac_no');
 if (bank && !/^\d+$/.test(bank)) {
   showError('bank_ac_no', 'Bank Account No must contain only digits.');
} else {
   clearError('bank_ac_no');
}
clearError('bank_account_not_available_reason');
} else {
 const reasonVal = document.getElementById('bank_account_not_available_reason').value;
 if (!reasonVal) {
   showError('bank_account_not_available_reason', 'Please select Reason for Non-Availability of Bank Account.');
} else {
   clearError('bank_account_not_available_reason');
}
clearError('bank_ac_no');
clearError('bank_ifsc');
clearError('beneficiary_bank_file');
}
   ...
   $(document).ready(function () {
     ...
     function toggleDisabilityFields() {
         ...
         if (isDisabled == '2') { // NO
             ...
             // Clear text/select/file values (excluding radio values)
             $('.disability_section')
                 .find('input:not([type="radio"]), select')
                 .val('');

             // Uncheck radio buttons inside
             $('.disability_section')
                 .find('input[type="radio"]')
                 .prop('checked', false);

             // Clear verification check message
             $('#check_udid_no').html('');
             ...
             // Restore default selection for having_udid if none is checked
             if ($('input[name="having_udid"]:checked').length === 0) {
                 $('#having_udid_yes').prop('checked', true);
             }
    ...
    function toggleUdidFields() {
        const isDisabled = $('input[name="is_disabled"]:checked').val();
        if (isDisabled == '2') return;

        const havingUdid = $('input[name="having_udid"]:checked').val();

        if (havingUdid == '2') { // NO
            $('.udid_certificate_section').hide();
            $('.udid_certificate_section')
                .find('input, select')
                .val('')
                .prop('disabled', true);
            ...
            $('.udid_reason_section').show();
            $('.udid_reason_section')
                .find('input, select')
                .prop('disabled', false);
        } else { // YES
            $('.udid_certificate_section').show();
            $('.udid_certificate_section')
                .find('input, select')
                .prop('disabled', false);

            $('.udid_reason_section').hide();
            $('.udid_reason_section')
                .find('input, select')
                .val('')
                .prop('disabled', true);
    ...
    $('input[name="having_udid"]').on('change', function () {
        toggleUdidFields();
    });
...
<script>
   $(document).ready(function () {
      function toggleBankFields() {
         const havingBankAccount = $('input[name="having_bank_account"]:checked').val();

         if (havingBankAccount == '2') { // NO
            // Hide entire Bank section (clean way)
            $('.bank_section').hide();
            ...
            // Hide check message element if any
            $('#check_bank_ac_no').html('');

            // Show Bank reason section
            $('.bank_reason_section').show();
            ...
            // Hide Bank reason section
            $('.bank_reason_section').hide();
      ...
      // On change
      $('input[name="having_bank_account"]').on('change', function () {
         toggleBankFields();
      });
   });
</script>
