                     ...
                     <div class="row">
                        <div class="col-lg-12" id="username_div">
                           <div class="form-group">
                              ...
                              <input type="text" name="name" value="{{ old('name') }}" class="form-control textInput" id="role_id" placeholder="Enter Role Name">
                              ...
                              <div class="card-body">
                                 <div class="d-flex flex-row">
                                    <div class="m-l-10 align-self-center">
                                       <h5 class="m-b-0"><input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600" name="permission[{{$value->id}}]" value="{{$value->id}}"> {{ $value->name }}</h5>
                                    </div>
                                 </div>
                              </div>
                           </div>
