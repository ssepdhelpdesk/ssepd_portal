...
<html>
   ...
   <body marginheight=0 marginwidth=0 topmargin=0 leftmargin=0 style="height: 100% !important; margin: 0; padding: 0; width: 100% !important;min-width: 100%;">
      <table name="bmeMainBody" style="background-color: rgb(255, 144, 0);" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ff9000">
         <tbody>
            <tr>
                     ...
                     <tbody>
                        <tr>
                           <td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate; border-spacing: 0px;">
                              <table name="bmeMainColumn" class="" style="max-width: 100%; border-radius: 0px; border-collapse: separate; border-spacing: 0px;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                 <tbody>
                                    <tr>
                                       <td class="blk_container bmeHolder" name="bmePreHeader" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(34, 34, 34);" width="100%" valign="top" bgcolor="#222222" align="center">
                                                   ...
                                                   <tr>
                                                      <td name="tblCell" style="padding:20px;" valign="top" align="left">
                                                         <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody>
                                                               <tr>
                                                                  <td name="bmePermissionText" style="text-align: center;" align="center"><span style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px;line-height: 140%;"><a style="color: #16a7e0;" target="_new" href="[ViewWebURL]">View this email in your browser</a></span></td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                      </td>
                                    ...
                                    <tr>
                                       <td class="bmeHolder" name="bmeMainContentParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;" width="100%" valign="top" align="center">
                                          <table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                             <tbody>
                                                <tr>
                                                   <td class="blk_container bmeHolder" name="bmeHeader" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(34, 34, 34);" width="100%" valign="top" bgcolor="#222222" align="center">
                                                                                    ...
                                                                                    <tbody>
                                                                                       <tr>
                                                                                          <td name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: rgb(56, 56, 56); text-align: left;" valign="top" align="left">
                                                                                             <div style="line-height: 150%; text-align: center;"><span style="font-size: 24px; font-family: Arial, Helvetica, sans-serif; color: #ff9000; line-height: 150%;">- Thank You for Registering, {{ $ngoOrgName }} -</span></div>
                                                                                          </td>
                                                                                       </tr>
                                                                                    </tbody>
                                                                                 </table>
                                                               ...
                                                               <tr>
                                                                  <td>
                                                                     <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="bmeImage" style="padding: 0px; border-collapse: collapse;" align="center"><img src="https://www.benchmarkemail.com/images/templates_n/new_editor/Templates/Clock/Clock.png" style="max-width: 1200px; display: block; width: 600px;" alt="" width="600" border="0"></td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
                                                                  </td>
                                                ...
                                                <tr>
                                                   <td class="blk_container bmeHolder" name="bmeBody" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 144, 0);" width="100%" valign="top" bgcolor="#ff9000" align="center">
                                                                              ...
                                                                              <td class="tdPart" valign="top" align="center">
                                                                                 <table name="tblText" style="float:left; background-color:transparent;" width="600" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                    <tbody>
                                                                                       <tr>
                                                                                          <td name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; color: rgb(56, 56, 56); text-align: left;" valign="top" align="left">
                                                                                             <div style="line-height: 150%; text-align: center;"><span style="font-size: 24px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;"><strong>You have completed your {{ $ngoRegdPhase }} step of NGO registration</strong></span></div>
                                                                                          </td>
                                                                                       </tr>
                                                                                    </tbody>
                                                                                 </table>
                                                                                    ...
                                                                                    <tbody>
                                                                                       <tr>
                                                                                          <td name="tblCell" style="padding-top: 10px; padding-bottom:10px; padding-left:20px; padding-right:20px; font-family: Arial,Helvetica,sans-serif; font-size: 14px; font-weight: normal; color: #383838; text-align: left;" valign="top" align="left">
                                                                                             <div style="line-height: 150%; text-align: center;"><span style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;">Below you can Find your Details</span></div>
                                                                                          </td>
                                                                                       </tr>
                                                                                    </tbody>
                                                                                 </table>
                                                      ...
                                                      <div id="dv_16" class="blk_wrapper">
                                                         <table class="blk" name="blk_boxtext" width="600" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody>
                                                               <tr>
                                                                  <td name="bmeBoxContainer" style="padding-left:20px; padding-right:20px; padding-top:0px; padding-bottom:0px;" align="center">
                                                                     <table name="tblText" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td style="padding: 20px; font-family:Arial, Helvetica, sans-serif; font-weight: normal; font-size: 14px; color: #383838;background-color:rgb(34, 34, 34); border-collapse: collapse;" name="tblCell" valign="top" align="left">
                                                                                 @if ($ngoRegdPhase == 'initial')
                                                                                 <div style="line-height: 150%; text-align: center;"><span style="font-size: 24px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;"><strong>Save this for future reference</strong></span><br><br><span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;">NGO Name: <strong>{{ $ngoOrgName }}</strong><br>New Registration No: <strong>{{ $registrationNumber }}</strong><br>Email: <strong>{{ $ngoOrgEmail }}</strong><br>User ID: <strong>{{ $ngoUserId }}</strong><br>Password: <strong>{{ $ngoUserPassword }}</strong><br>Phone: <strong>{{ $ngoOrgPhone }}</strong></span></div>
                                                                                 @else
                                                                                 <div style="line-height: 150%; text-align: center;"><span style="font-size: 24px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;"><strong>Save this for future reference</strong></span><br><br><span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;">NGO Name: <strong>{{ $ngoOrgName }}</strong><br>Previous Registration No: <strong>{{ $ngoRegNo }}</strong><br>New Registration No: <strong>{{ $registrationNumber }}</strong><br>Email: <strong>{{ $ngoOrgEmail }}</strong><br>User ID: <strong>{{ $ngoUserId }}</strong><br>Password: <strong>{{ $ngoUserPassword }}</strong><br>Phone: <strong>{{ $ngoOrgPhone }}</strong><br>Web URL: <strong>{{ $ngoOrgWebsite }}</strong></span></div>
                                                                                 @endif
                                                                              </td>
                                                                           </tr>
                                                                        </tbody>
                                                               ...
                                                               <tr>
                                                                  <td>
                                                                     <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody>
                                                                           <tr>
                                                                              <td class="bmeImage" style="border-collapse: collapse; padding: 0px;" align="center"><img src="https://www.benchmarkemail.com/images/templates_n/new_editor/Templates/Clock/Shadow.png" style="max-width: 1200px; display: block; width: 600px;" alt="" width="600" border="0"></td>
                                                                           </tr>
                                                                        </tbody>
                                                                     </table>
                                                                  </td>
                                                ...
                                                <tr>
                                                   <td class="blk_container bmeHolder" name="bmePreFooter" style="border: 0px none transparent; background-color: rgb(255, 144, 0);" width="100%" valign="top" bgcolor="#ff9000" align="center">
                                                      ...
                                                      <div id="dv_8" class="blk_wrapper">
                                                         <table style="" name="blk_social_follow" class="blk" width="600" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody>
                                                               <tr>
                                                                                       ...
                                                                                       <tr>
                                                                                          ...
                                                                                          <td align="left" valign="top">
                                                                                             ...
                                                                                             <table class="bmeFollowItem" type="twitter" style="float: left; display: block;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                                <tbody>
                                                                                                   <tr>
                                                                                                      <td class="bmeFollowItemIcon" gutter="10" style="padding-right:10px;height:20px;" width="24" align="left"><a href="http://twitter.com" style="display: inline-block;background-color: rgb(34, 34, 34);border-radius: 28px;border-style: solid; border-width: 1px; border-color: rgb(255, 255, 255);" target="_blank"><img src="https://ui.benchmarkemail.com/images/editor/socialicons/tw_btn.png" alt="Twitter" style="display: block; max-width: 114px;" width="24" height="24" border="0"></a></td>
                                                                                                   </tr>
                                                                                                </tbody>
                                                                                             </table>
                                                                                             <!--[if gte mso 6]>
                                                                                          ...
                                                                                          <td align="left" valign="top">
                                                                                             ...
                                                                                             <table class="bmeFollowItem" type="instagram" style="float: left; display: block;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                                <tbody>
                                                                                                   <tr>
                                                                                                      <td class="bmeFollowItemIcon" gutter="10" style="height:20px;" width="24" align="left"><a href="http://instagram.com" style="display: inline-block;background-color: rgb(34, 34, 34);border-radius: 28px;border-style: solid; border-width: 1px; border-color: rgb(255, 255, 255);" target="_blank"><img src="https://ui.benchmarkemail.com/images/editor/socialicons/in_btn.png" alt="Instagram" style="display: block; max-width: 114px;" width="24" height="24" border="0"></a></td>
                                                                                                   </tr>
                                                                                                </tbody>
                                                                                             </table>
                                                                                          </td>
