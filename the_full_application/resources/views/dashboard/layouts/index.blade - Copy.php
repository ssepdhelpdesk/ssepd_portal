                        ...
                        <div class="carousel-inner">
                           <div class="carousel-item active">
                              ...
                              <div class="d-flex no-block">
                                 <span><img src="{{ asset('dashboard_assets/assets/images/users/1.jpg') }}" alt="user" width="50" class="img-circle"></span>
                                 <span class="m-l-10">
                           ...
                           <div class="carousel-item">
                              <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                              <div class="d-flex no-block">
                                 <span><img src="{{ asset('dashboard_assets/assets/images/users/2.jpg') }}" alt="user" width="50" class="img-circle"></span>
                                 <span class="m-l-10">
                                    <h4 class="text-white m-b-0">Govinda</h4>
                                    <p class="text-white">Actor</p>
                                 </span>
                           ...
                           <div class="carousel-item">
                              <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                              <div class="d-flex no-block">
                                 <span><img src="{{ asset('dashboard_assets/assets/images/users/3.jpg') }}" alt="user" width="50" class="img-circle"></span>
                                 <span class="m-l-10">
                                    <h4 class="text-white m-b-0">Govinda</h4>
                                    <p class="text-white">Actor</p>
                                 </span>
         ...
         <div class="card">
            ...
            <div class="comment-widgets" id="comment" style="height: 629px;position: relative;">
               ...
               <div class="d-flex no-block comment-row">
                  <div class="p-2"><span class="round"><img src="{{ asset('dashboard_assets/assets/images/users/1.jpg') }}" alt="user" width="50"></span></div>
               ...
               <div class="d-flex no-block comment-row border-top">
                  <div class="p-2"><span class="round"><img src="{{ asset('dashboard_assets/assets/images/users/2.jpg') }}" alt="user" width="50"></span></div>
               ...
               <!-- Comment Row -->
               <div class="d-flex no-block comment-row border-top">
                  <div class="p-2"><span class="round"><img src="{{ asset('dashboard_assets/assets/images/users/3.jpg') }}" alt="user" width="50"></span></div>
                  <div class="comment-text w-100">
               ...
               <!-- Comment Row -->
               <div class="d-flex no-block comment-row border-top">
                  <div class="p-2"><span class="round"><img src="{{ asset('dashboard_assets/assets/images/users/4.jpg') }}" alt="user" width="50"></span></div>
                  <div class="comment-text active w-100">
                  ...
                  <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                     <li class="list-group-item" data-role="task">
                        ...
                        <ul class="assignedto mt-2">
                           <li><img src="{{ asset('dashboard_assets/assets/images/users/1.jpg') }}" alt="user" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                           <li><img src="{{ asset('dashboard_assets/assets/images/users/2.jpg') }}" alt="user" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                           <li><img src="{{ asset('dashboard_assets/assets/images/users/3.jpg') }}" alt="user" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                           <li><img src="{{ asset('dashboard_assets/assets/images/users/4.jpg') }}" alt="user" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                        </ul>
                     </li>
                     <li class="list-group-item" data-role="task">
                        <div class="form-check d-flex align-items-start">
               ...
               <div class="message-box" id="msg" style="height: 430px;position: relative;">
                  <div class="message-widget message-scroll">
                     ...
                     <a href="javascript:void(0)">
                        <div class="user-img"> <img src="{{ asset('dashboard_assets/assets/images/users/1.jpg') }}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                     ...
                     <!-- Message -->
                     <a href="javascript:void(0)">
                        <div class="user-img"> <img src="{{ asset('dashboard_assets/assets/images/users/2.jpg') }}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                        <div class="mail-contnet">
                           <h5>Sonu Nigam</h5>
                     ...
                     <!-- Message -->
                     <a href="javascript:void(0)">
                        <div class="user-img"> <img src="{{ asset('dashboard_assets/assets/images/users/4.jpg') }}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                        <div class="mail-contnet">
                           <h5>Pavan kumar</h5>
            ...
            <div class="card-body">
               ...
               <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                  ...
                  <ul class="chat-list">
                     <!--chat Row -->
                     <li>
                        <div class="chat-img"><img src="{{ asset('dashboard_assets/assets/images/users/1.jpg') }}" alt="user"></div>
                     ...
                     <!--chat Row -->
                     <li>
                        <div class="chat-img"><img src="{{ asset('dashboard_assets/assets/images/users/2.jpg') }}" alt="user"></div>
                        <div class="chat-content">
                           <h5>Bianca Doe</h5>
                     ...
                     <!--chat Row -->
                     <li>
                        <div class="chat-img"><img src="{{ asset('dashboard_assets/assets/images/users/3.jpg') }}" alt="user"></div>
                        <div class="chat-content">
