         ...
         <div class="card">
            <div class="card-body">
               ...
               <ul class="nav nav-tabs customtab2" role="tablist">
                  ...
                  <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#part2" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Profile</span></a> </li>
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane  p-20" id="part2" role="tabpanel">2</div>
...
<script>
         ...
         case '#tab1':
            ...
            $(document).ready(function () {
               ...
               $('form').on('submit', function () {
                  ...
                  ['ngo_org_pan_file', 'ngo_file_rc', 'ngo_file_byelaws'].forEach(id => {
                     const fileInput = document.getElementById(id);
                     if (!fileInput.value) {
                        showError(id, 'Please upload the file.');
                     } else {
                        ...
                        if (file && file.size > 2 * 1024 * 1024) {
                           Swal.fire({
                              ...
                              text: `The file "${file.name}" exceeds 2MB. Please upload a smaller file.`,
                           });
                           isValid = false;
                        }
                     }
   ...
   /*Place tab 2 specific code here*/
            break;
         case '#part3':
            console.log('Tab 3 script executing...');
   /*Place tab 3 specific code here*/
            break;
         default:
