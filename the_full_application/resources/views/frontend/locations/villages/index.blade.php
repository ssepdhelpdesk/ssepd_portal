         ...
         <div class="card">
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <h5 class="m-t-30">Block</h5>
                     <select class="select2 form-control form-select" id="block-dropdown" style="width: 100%; height:36px;">
                     </select>
                  </div>
                  <div class="col-md-4">
                     <h5 class="m-t-30">Grampanchayat</h5>
                     <select class="select2 form-control form-select" id="grampanchayat-dropdown" style="width: 100%; height:36px;">
                     </select>
                  </div>
                  <div class="col-md-4">
                     <h5 class="m-t-30">Village</h5>
                     <select class="select2 form-control form-select" id="village-dropdown" style="width: 100%; height:36px;">
                     </select>
                  </div>
               </div>
            </div>
