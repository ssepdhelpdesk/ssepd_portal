...
if (verifyBtn && aadhaarInput) {
   ...
   verifyBtn.addEventListener('click', function () {
      ...
      setTimeout(function () {
         ...
         const apiSuccess = true; // simulate success
         ...
         if (apiSuccess) {
            ...
            Swal.fire('Verified', 'Aadhaar verified successfully', 'success');

         } else {

            aadhaarVerified = false;

            Swal.fire('Failed', 'Aadhaar verification failed', 'error');
...
/* Reset verification if Aadhaar edited */
if (aadhaarInput) {
...
<script>
   document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ================= UNIVERSAL FILE SIZE VALIDATION (500KB) ================= */
      ...
      function validateFormFields(form) {
       ...
       if (firstInvalid) {
           ...
           Swal.fire({
               ...
               text: 'Please fill all required red marked fields & Beneficiary Image before submitting.',
               confirmButtonText: 'OK'
           }).then(() => {
