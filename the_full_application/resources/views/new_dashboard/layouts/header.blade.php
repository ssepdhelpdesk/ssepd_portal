          ...
          <div class="page-header">
             <div class="header-wrapper row m-0">
                ...
                <div class="header-logo-wrapper col-auto p-0">
                   <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('new_dashboard_assets/assets/images/logo/logo.png') }}" alt=""><img class="img-fluid for-dark" src="{{ asset('new_dashboard_assets/assets/images/logo/logo_dark.png') }}" alt=""></a></div>
                   <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
                </div>
                <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
                   <div class="notification-slider">
                      <div class="d-flex h-100">
                         <img src="{{ asset('new_dashboard_assets/assets/images/giftools.gif') }}" alt="gif">
                         <h6 class="mb-0 f-w-400"><span class="font-primary">Don't Miss Out! </span><span class="f-light"> Our new update has been released.</span></h6>
                ...
                <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
                   <ul class="nav-menus">
                      ...
                      <li class="fullscreen-body">
                         <span>
                            <svg id="maximize-screen">
                               <use href="{{ asset('new_dashboard_assets/assets/svg/icon-sprite.svg') }}#full-screen"></use>
                            </svg>
                         </span>
                      </li>
                      <li>
                         <span class="header-search">
                            <svg>
                               <use href="{{ asset('new_dashboard_assets/assets/svg/icon-sprite.svg') }}#search"></use>
                            </svg>
                         </span>
                      </li>
                      <li class="onhover-dropdown">
                         <svg>
                            <use href="{{ asset('new_dashboard_assets/assets/svg/icon-sprite.svg') }}#star"></use>
                         </svg>
                            ...
                            <div class="flip-card">
                               <div class="flip-card-inner">
                                  ...
                                  <div class="back">
                                     <ul>
                                        <li>
                                           <div class="bookmark-dropdown flip-back-content"><input type="text" placeholder="Search..."></div>
                                        </li>
                      ...
                      <li>
                         <div class="mode">
                            <svg>
                               <use href="{{ asset('new_dashboard_assets/assets/svg/icon-sprite.svg') }}#moon"></use>
                            </svg>
                         </div>
                      </li>
                      <li class="cart-nav onhover-dropdown">
                         ...
                         <div class="cart-dropdown onhover-show-div">
                            ...
                            <ul>
                               <li>
                                  <div class="d-flex">
                                     <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('new_dashboard_assets/assets/images/other-images/cart-img.jpg') }}" alt="">
                               ...
                               <li>
                                  <div class="d-flex">
                                     <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('new_dashboard_assets/assets/images/other-images/cart-img1.jpg') }}" alt="">
                                     <div class="flex-grow-1">
                      ...
                      <li class="onhover-dropdown">
                         <div class="notification-box">
                            <svg>
                               <use href="{{ asset('new_dashboard_assets/assets/svg/icon-sprite.svg') }}#notification"></use>
                            </svg>
                      ...
                      <li class="profile-nav onhover-dropdown pe-0 py-0">
                         <div class="d-flex profile-media">
                            <img class="b-r-10" src="{{ asset('new_dashboard_assets/assets/images/dashboard/profile.png') }}" alt="">
                            <div class="flex-grow-1">
                ...
                </script><script class="empty-template" type="text/x-handlebars-template"><div class="EmptyMessage">Your search turned up 0 results. This most likely means the backend is down, yikes!</div></script>
             </div>
          </div>
          <!-- Page Header Ends                              -->
