...
class ThirtyFiveHundredPensionerController extends Controller
{
    public function getDisabilityPensioners(Request $request)
    {
    ...
    /*Fetch Old Age Pensioners*/
    public function getOldAgePensioners(Request $request)
    {
    ...
    public function getDisabilityPensionerByAadhar($aadhaar_no)
    {
    ...
    public function getOldAgePensionerByAadhar($aadhaar_no)
    {
    ...
    /* Fetch Old Age Pensioner by Aadhaar */
    public function getOldAgePensionerByAadharRequiredData($aadhaar_no)
    {
        $record = OldAge3500Pensioner::where('aadhaar_no', $aadhaar_no)->first();
    ...
    /* Fetch Disability Pensioner by Aadhaar */
    public function getDisabilityPensionerByAadharRequiredData($aadhaar_no)
    {
        $record = Disability3500Pensioner::where('aadhaar_no', $aadhaar_no)->first();
