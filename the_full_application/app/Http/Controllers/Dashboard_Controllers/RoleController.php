...
class RoleController extends Controller
{
    ...
    {
         $this->middleware('permission:role-access|role-list|role-create|role-edit|role-delete', ['only' => ['index','store']]);
    ...
    public function show($id): View
    {
        ...
        return view('dashboard.roles.show',compact('role','permission','rolePermissions'));
    }
    ...
    {
        $this->validate($request, [
            'name' => 'required|unique:roles,name,'.$id.',id|min:2',
            'permission' => 'required',
        ]);
